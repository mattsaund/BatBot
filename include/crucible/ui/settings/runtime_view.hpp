...
//
// The Runtimes panel: install and remove compute backends from inside Crucible.
//
// This is the screen that makes a CPU-only install into a CUDA one without
// touching a terminal. It lists every backend Crucible knows how to build, what
